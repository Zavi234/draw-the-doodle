...
function check_sketch(e,r)
{
    if(e){
     ...
     {
        console.log(r)
        document.getElementById("show_sketch_name").innerHTML= r[0].label
        
        document.getElementById("confidence").innerHTML= Math.floor(r[0].confidence*100)+"%"
     }
}
